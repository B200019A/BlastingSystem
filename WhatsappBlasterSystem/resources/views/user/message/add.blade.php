...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-12 col-md-6 mt-md-5 border p-2 p-md-5 rounded-5" style="background-color: #e8e8e8;">
                <h3 class="text-center mb-5">Create new blaster message list</h3>
                @if (isset($message))
